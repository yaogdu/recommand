...
<head>
    ...
    <link href="../../../resources/css/meet/pushed.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<div class="container">
    ...
    <div class="search"><input id="sequence" class="input" type="text" placeholder="请输入约见ID" name=""
                               value=""/><input
            type="button" id="search" class="btn_blue" value="查询"/><input
            type="button" id="return_home" class="btn_blue" value="返回"/></div>
...
<script type="text/javascript" src="../../../resources/js/meet/pushed.js"></script>
<script type="text/javascript">

    $(document).ready(function () {
        app.meet.pushed.init();
        $('.tooltip').tooltipster({
            animation: 'fade',
            delay: 200,
