...
<head>
    ...
    <link href="../../../resources/css/meet/viewed.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<div class="container">
...
<script type="text/javascript" src="../../../resources/js/meet/viewed.js"></script>
<script type="text/javascript">

    $(document).ready(function () {
        app.meet.viewed.init();
        $('.tooltip').tooltipster({
            animation: 'fade',
            delay: 200,
